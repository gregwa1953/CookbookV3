...
#  Mar 21, 2020 10:43:58 AM CDT  platform: Linux
set vTcl(timestamp) ""
...
proc vTclWindow.top43 {base} {
    ...
    place $site_3_0.but47 \
        -in $site_3_0 -x 630 -y 3 -width 38 -relwidth 0 -height 38 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.but49 \
        -in $site_3_0 -x 766 -y 3 -width 38 -relwidth 0 -height 38 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.but50 \
        -in $site_3_0 -x 882 -y 3 -width 38 -relwidth 0 -height 38 \
        -relheight 0 -anchor nw -bordermode ignore 
