...
#  Jan 31, 2020 04:28:02 PM CST  platform: Linux
set vTcl(timestamp) ""
...
proc vTclWindow.top43 {base} {
    ...
    vTcl:DefineAlias "$top" "Scraper" vTcl:Toplevel:WidgetProc "" 1
    button $top.but44 \
        -activebackground #f9f9f9 -activeforeground black \
    ...
    vTcl:DefineAlias "$top.but44" "btnExit" vTcl:WidgetProc "Scraper" 1
    label $top.lab45 \
    ...
    vTcl:DefineAlias "$top.lab45" "Label1" vTcl:WidgetProc "Scraper" 1
    entry $top.ent46 \
        -background white -font {-family {DejaVu Sans Mono} -size 8} \
        -foreground $vTcl(actual_gui_fg) -highlightcolor black \
        -insertbackground black -selectbackground #c4c4c4 \
        -selectforeground black -textvariable EntryWebsite -width 596
    vTcl:DefineAlias "$top.ent46" "Entry1" vTcl:WidgetProc "Scraper" 1
    label $top.lab47 \
        -activebackground #f9f9f9 -activeforeground black \
    ...
    vTcl:DefineAlias "$top.lab47" "lblTitle" vTcl:WidgetProc "Scraper" 1
    label $top.lab48 \
        -activebackground #f9f9f9 -activeforeground black \
        -background $vTcl(actual_gui_bg) -borderwidth 2 -font TkDefaultFont \
        -foreground $vTcl(actual_gui_fg) -highlightcolor black -relief ridge \
        -text Label -textvariable sTotalTime
    vTcl:DefineAlias "$top.lab48" "lblTotalTime" vTcl:WidgetProc "Scraper" 1
    label $top.lab49 \
        -activebackground #f9f9f9 -activeforeground black \
        -background $vTcl(actual_gui_bg) -borderwidth 2 -font TkDefaultFont \
        -foreground $vTcl(actual_gui_fg) -highlightcolor black -relief ridge \
        -text Label -textvariable sYields
    vTcl:DefineAlias "$top.lab49" "lblYields" vTcl:WidgetProc "Scraper" 1
    vTcl::widgets::ttk::scrolledlistbox::CreateCmd $top.scr50 \
        -background $vTcl(actual_gui_bg) -height 75 -highlightcolor black \
        -width 125
    vTcl:DefineAlias "$top.scr50" "Scrolledlistbox1" vTcl:WidgetProc "Scraper" 1
    ...
    vTcl:DefineAlias "$top.scr51" "Scrolledtext1" vTcl:WidgetProc "Scraper" 1
    ...
    vTcl:DefineAlias "$top.lab53" "lblImageURL" vTcl:WidgetProc "Scraper" 1
    button $top.but54 \
        -activebackground #f9f9f9 -activeforeground black \
    ...
    vTcl:DefineAlias "$top.but54" "btnGo" vTcl:WidgetProc "Scraper" 1
    label $top.lab55 \
        -activebackground #f9f9f9 -activeforeground black -anchor e \
        -background $vTcl(actual_gui_bg) \
        -font {-family {DejaVu Sans} -size 10 -weight bold} \
        -foreground $vTcl(actual_gui_fg) -highlightcolor black -text Title:
    vTcl:DefineAlias "$top.lab55" "Label2" vTcl:WidgetProc "Scraper" 1
    label $top.lab56 \
        -activebackground #f9f9f9 -activeforeground black -anchor e \
        -background $vTcl(actual_gui_bg) \
        -font {-family {DejaVu Sans} -size 10 -weight bold} \
        -foreground $vTcl(actual_gui_fg) -highlightcolor black \
        -text {Total Time:}
    vTcl:DefineAlias "$top.lab56" "Label3" vTcl:WidgetProc "Scraper" 1
    label $top.lab57 \
        -activebackground #f9f9f9 -activeforeground black -anchor e \
        -background $vTcl(actual_gui_bg) \
        -font {-family {DejaVu Sans} -size 10 -weight bold} \
        -foreground $vTcl(actual_gui_fg) -highlightcolor black -text Yields:
    vTcl:DefineAlias "$top.lab57" "Label4" vTcl:WidgetProc "Scraper" 1
    label $top.lab58 \
        -activebackground #f9f9f9 -activeforeground black -anchor e \
        -background $vTcl(actual_gui_bg) \
        -font {-family {DejaVu Sans} -size 10 -weight bold} \
        -foreground $vTcl(actual_gui_fg) -highlightcolor black \
        -text {Image URL:}
    vTcl:DefineAlias "$top.lab58" "Label5" vTcl:WidgetProc "Scraper" 1
    label $top.lab59 \
        -activebackground #f9f9f9 -activeforeground black \
        -background $vTcl(actual_gui_bg) -borderwidth 2 -font TkDefaultFont \
        -foreground $vTcl(actual_gui_fg) -highlightcolor black -relief ridge \
        -text Label
    vTcl:DefineAlias "$top.lab59" "lblImage" vTcl:WidgetProc "Scraper" 1
    label $top.lab60 \
        ...
        -foreground $vTcl(actual_gui_fg) -highlightcolor black \
        -text Ingredients:
    vTcl:DefineAlias "$top.lab60" "Label7" vTcl:WidgetProc "Scraper" 1
    label $top.lab61 \
        -activebackground #f9f9f9 -activeforeground black -anchor w \
        -background $vTcl(actual_gui_bg) \
        -font {-family {DejaVu Sans} -size 10 -weight bold} \
        -foreground $vTcl(actual_gui_fg) -highlightcolor black \
        -text Instructions:
    vTcl:DefineAlias "$top.lab61" "Label8" vTcl:WidgetProc "Scraper" 1
    button $top.but43 \
        -activebackground #f9f9f9 -activeforeground black \
    ...
    vTcl:DefineAlias "$top.but43" "btnSaveToDB" vTcl:WidgetProc "Scraper" 1
    label $top.lab44 \
        -activebackground #f9f9f9 -activeforeground black -anchor w \
        -background $vTcl(actual_gui_bg) \
        -font {-family {DejaVu Sans} -size 10 -weight bold} \
        -foreground $vTcl(actual_gui_fg) -highlightcolor black \
        -text Categories:
    vTcl:DefineAlias "$top.lab44" "Label8_1" vTcl:WidgetProc "Scraper" 1
    frame $top.fra45 \
        -borderwidth 3 -relief sunken -background $vTcl(actual_gui_bg) \
        -height 305 -highlightcolor black -width 295
    vTcl:DefineAlias "$top.fra45" "frameCustomWidget" vTcl:WidgetProc "Scraper" 1
    set site_3_0 $top.fra45
    vTcl::widgets::ttk::custom::CreateCmd $site_3_0.cus46 \
        -background $vTcl(actual_gui_bg) -height 75 -highlightcolor black \
        -width 125
    vTcl:DefineAlias "$site_3_0.cus46" "Custom1" vTcl:WidgetProc "Scraper" 1
    ...
    vTcl:DefineAlias "$top.mes47" "Message1" vTcl:WidgetProc "Scraper" 1
    vTcl::widgets::ttk::scrolledtext::CreateCmd $top.scr43 \
        -borderwidth 2 -relief groove -background $vTcl(actual_gui_bg) \
        -height 75 -highlightcolor black -width 125
    vTcl:DefineAlias "$top.scr43" "stDescription" vTcl:WidgetProc "Scraper" 1
    ...
    label $top.lab46 \
        -activebackground #f9f9f9 -activeforeground black -anchor w \
        -background $vTcl(actual_gui_bg) \
        -font {-family {Ubuntu} -size 11 -weight bold} \
        -foreground $vTcl(actual_gui_fg) -highlightcolor black \
        -text Description:
    vTcl:DefineAlias "$top.lab46" "Label6" vTcl:WidgetProc "Scraper" 1
    ###################
    # SETTING GEOMETRY
    ###################
    place $top.but44 \
    ...
    place $top.ent46 \
        ...
        -height 31 -relheight 0 -anchor nw -bordermode ignore
    place $top.lab47 \
        -in $top -x 0 -relx 0.154 -y 0 -rely 0.139 -width 0 -relwidth 0.538 \
    ...
    place $top.lab49 \
        ...
        -height 0 -relheight 0.037 -anchor nw -bordermode ignore
    place $top.scr50 \
        -in $top -x 0 -relx 0.273 -y 0 -rely 0.613 -width 0 -relwidth 0.277 \
        -height 0 -relheight 0.371 -anchor nw -bordermode ignore
    place $top.scr51 \
        -in $top -x 0 -relx 0.562 -y 0 -rely 0.613 -width 0 -relwidth 0.41 \
        -height 0 -relheight 0.371 -anchor nw -bordermode ignore
    place $top.lab53 \
        -in $top -x 0 -relx 0.154 -y 0 -rely 0.29 -width 0 -relwidth 0.543 \
    ...
    place $top.lab58 \
        ...
        -height 0 -relheight 0.024 -anchor nw -bordermode ignore
    place $top.lab59 \
        -in $top -x 0 -relx 0.71 -y 0 -rely 0.146 -width 0 -relwidth 0.249 \
        -height 0 -relheight 0.365 -anchor nw -bordermode ignore
    place $top.lab60 \
        -in $top -x 0 -relx 0.281 -y 0 -rely 0.58 -width 0 -relwidth 0.103 \
        -height 0 -relheight 0.023 -anchor nw -bordermode ignore
    place $top.lab61 \
        -in $top -x 0 -relx 0.57 -y 0 -rely 0.58 -width 0 -relwidth 0.123 \
        -height 0 -relheight 0.028 -anchor nw -bordermode ignore
    place $top.but43 \
        -in $top -x 0 -relx 0.545 -y 0 -rely 0.219 -width 159 -relwidth 0 \
        -height 29 -relheight 0 -anchor nw -bordermode ignore
    place $top.lab44 \
        -in $top -x 0 -relx 0.025 -y 0 -rely 0.58 -width 0 -relwidth 0.123 \
        -height 0 -relheight 0.028 -anchor nw -bordermode ignore
    place $top.fra45 \
        -in $top -x 0 -relx 0.017 -y 0 -rely 0.613 -width 0 -relwidth 0.244 \
        -height 0 -relheight 0.371 -anchor nw -bordermode ignore
    place $top.mes47 \
        -in $top -x 0 -relx 0.017 -y 0 -rely 0.426 -width 0 -relwidth 0.244 \
        -height 0 -relheight 0.125 -anchor nw -bordermode ignore
    place $top.scr43 \
        -in $top -x 0 -relx 0.273 -y 0 -rely 0.426 -width 0 -relwidth 0.423 \
        -height 0 -relheight 0.129 -anchor nw -bordermode ignore
    place $top.lab46 \
        -in $top -x 0 -relx 0.277 -y 0 -rely 0.394 -width 0 -relwidth 0.092 \
        -height 0 -relheight 0.023 -anchor nw -bordermode ignore
