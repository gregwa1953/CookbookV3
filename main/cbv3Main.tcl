...
#  Dec 23, 2020 03:55:26 AM CST  platform: Linux
set vTcl(timestamp) ""
...
proc vTclWindow.top43 {base} {
    ...
    wm geometry $top 1270x861+236+81
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    button $site_3_0.but51 \
        -activebackground #f9f9f9 -activeforeground black \
        -background $vTcl(actual_gui_bg) -command on_btnTips \
        -font TkDefaultFont -foreground $vTcl(actual_gui_fg) \
        -highlightcolor black -text Button 
    vTcl:DefineAlias "$site_3_0.but51" "btnTips" vTcl:WidgetProc "formCookbookMain" 1
    bind $site_3_0.but51 <<SetBalloon>> {
        set ::vTcl::balloon::%W {Show Tips and Tricks}
    }
    place $site_3_0.but48 \
        -in $site_3_0 -x 1210 -y 3 -width 38 -relwidth 0 -height 38 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.but43 \
        -in $site_3_0 -x 120 -y 3 -width 38 -relwidth 0 -height 38 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.but44 \
        -in $site_3_0 -x 170 -y 3 -width 38 -relwidth 0 -height 38 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.but45 \
        -in $site_3_0 -x 241 -y 3 -width 38 -relwidth 0 -height 38 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.but46 \
        -in $site_3_0 -x 504 -y 3 -width 38 -relwidth 0 -height 38 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.but47 \
        -in $site_3_0 -x 700 -y 3 -width 38 -relwidth 0 -height 38 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.but49 \
        -in $site_3_0 -x 811 -y 3 -width 38 -relwidth 0 -height 38 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.but50 \
        -in $site_3_0 -x 924 -y 3 -width 38 -relwidth 0 -height 38 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.but51 \
        -in $site_3_0 -x 593 -y 3 -width 38 -relwidth 0 -height 38 \
        -relheight 0 -anchor nw -bordermode ignore 
    ...
    place $site_3_0.lab44 \
        -in $site_3_0 -x 1170 -y 10 -width 86 -relwidth 0 -height 29 \
        -relheight 0 -anchor nw -bordermode ignore 
    frame $top.fra46 \
        -borderwidth 3 -relief ridge -background $vTcl(actual_gui_bg) \
    ...
    frame $site_3_0.fra49 \
        ...
        -height 195 -highlightcolor black -width 347 
    ...
    radiobutton $site_4_0.rad46 \
        ...
        -background $vTcl(actual_gui_bg) -command on_rbClick \
        -font TkDefaultFont -foreground $vTcl(actual_gui_fg) \
        -highlightcolor black -justify left -text Favorites -value 3 
    vTcl:DefineAlias "$site_4_0.rad46" "rbFavorites" vTcl:WidgetProc "formCookbookMain" 1
    place $site_4_0.lab54 \
        -in $site_4_0 -x 20 -y 10 -width 81 -relwidth 0 -height 21 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_4_0.rad43 \
        -in $site_4_0 -x 40 -y 36 -width 92 -relwidth 0 -height 21 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_4_0.rad44 \
        -in $site_4_0 -x 40 -y 60 -width 112 -relwidth 0 -height 21 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_4_0.rad45 \
        -in $site_4_0 -x 40 -y 84 -width 138 -relwidth 0 -height 21 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_4_0.che46 \
        -in $site_4_0 -x 210 -y 20 -width 113 -relwidth 0 -height 21 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_4_0.ent47 \
        -in $site_4_0 -x 20 -y 161 -width 310 -relwidth 0 -height 21 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_4_0.rad46 \
        -in $site_4_0 -x 40 -y 110 -anchor nw -bordermode ignore 
    ...
    vTcl:copy_lock $site_4_0.scr51
    place $site_4_0.scr51 \
        -in $site_4_0 -x 3 -y 0 -width 345 -relwidth 0 -height 548 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.fra49 \
        -in $site_3_0 -x 0 -y 558 -width 347 -relwidth 0 -height 195 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.fra50 \
        -in $site_3_0 -x 0 -y 2 -width 347 -relwidth 0 -height 550 \
        -relheight 0 -anchor nw -bordermode ignore 
    frame $top.fra47 \
        -borderwidth 3 -relief ridge -background $vTcl(actual_gui_bg) \
    ...
    $site_3_0.scr53.01 configure -background white \
        -cursor xterm \
        -font "-family {DejaVu Sans Mono} -size 9" \
        -foreground black \
        -height 3 \
    ...
    message $site_3_0.mes45 \
        -background $vTcl(actual_gui_bg) -cursor crosshair \
        -font {-family {DejaVu Sans} -size 10 -weight bold -slant italic} \
        -foreground blue2 -highlightcolor black -relief sunken -text Label \
        -textvariable RecipeSource -width 465 
    vTcl:DefineAlias "$site_3_0.mes45" "lblSource" vTcl:WidgetProc "formCookbookMain" 1
    label $site_3_0.lab55 \
        -activebackground #f9f9f9 -activeforeground black \
        -background $vTcl(actual_gui_bg) -borderwidth 2 -font TkDefaultFont \
        -foreground $vTcl(actual_gui_fg) -highlightcolor black -relief ridge \
        -text Label -textvariable LableFavorite 
    vTcl:DefineAlias "$site_3_0.lab55" "lblFave" vTcl:WidgetProc "formCookbookMain" 1
    bind $site_3_0.lab55 <Button-1> {
        lambda e: on_lblFaveClick(e)
    }
    place $site_3_0.scr52 \
        -in $site_3_0 -x 404 -y 411 -width 511 -relwidth 0 -height 346 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.scr53 \
        -in $site_3_0 -x 10 -y 411 -width 385 -relwidth 0 -height 346 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.lab43 \
        -in $site_3_0 -x 60 -y 9 -width 527 -relwidth 0 -height 39 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.lab44 \
        -in $site_3_0 -x 601 -y 20 -width 301 -relwidth 0 -height 300 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.mes43 \
        -in $site_3_0 -x 90 -y 350 -width 806 -relwidth 0 -height 43 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.lab47 \
        -in $site_3_0 -x 20 -y 361 -width 46 -relwidth 0 -height 19 \
        -relheight 0 -anchor nw -bordermode ignore 
    ...
    place $site_3_0.lab50 \
        -in $site_3_0 -x 30 -y 210 -width 83 -relwidth 0 -height 20 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.lab51 \
        -in $site_3_0 -x 119 -y 139 -width 467 -relwidth 0 -height 30 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.lab52 \
        -in $site_3_0 -x 20 -y 146 -width 89 -relwidth 0 -height 20 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.lab53 \
        -in $site_3_0 -x 120 -y 172 -width 467 -relwidth 0 -height 30 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.lab54 \
        -in $site_3_0 -x 30 -y 178 -width 79 -relwidth 0 -height 20 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.scr43 \
        -in $site_3_0 -x 120 -y 205 -width 469 -relwidth 0 -height 140 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.mes44 \
        -in $site_3_0 -x 120 -y 106 -width 466 -relwidth 0 -height 30 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.mes45 \
        -in $site_3_0 -x 120 -y 53 -width 466 -relwidth 0 -height 50 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.lab55 \
        -in $site_3_0 -x 7 -y 3 -width 50 -relwidth 0 -height 50 -relheight 0 \
    ...
    ###################
    place $top.fra44 \
        -in $top -x 0 -y 0 -width 1266 -relwidth 0 -height 50 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.fra45 \
        -in $top -x 0 -y 811 -width 1266 -relwidth 0 -height 50 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.fra46 \
        -in $top -x 0 -y 53 -width 351 -relwidth 0 -height 758 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.fra47 \
