...
#  Jan 22, 2020 02:57:42 AM CST  platform: Linux
set vTcl(timestamp) ""
...
proc vTclWindow.top43 {base} {
    ...
    place $site_3_0.but43 \
        -in $site_3_0 -x 117 -y 6 -width 38 -relwidth 0 -height 38 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.but44 \
        -in $site_3_0 -x 170 -y 6 -width 38 -relwidth 0 -height 38 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.but45 \
        -in $site_3_0 -x 221 -y 6 -width 38 -relwidth 0 -height 38 \
        -relheight 0 -anchor nw -bordermode ignore 
    ...
    label $site_3_0.lab53 \
        ...
        -foreground $vTcl(actual_gui_fg) -relief ridge -text Label \
        -textvariable RecipeRating 
    ...
    label $site_3_0.lab54 \
        ...
        -font {-family {Ubuntu} -size 10 -weight bold} \
        -foreground $vTcl(actual_gui_fg) -text Rating: 
    ...
    place $site_3_0.mes47 \
        -in $site_3_0 -x 120 -y 185 -width 455 -relwidth 0 -height 113 \
        -relheight 0 -anchor nw -bordermode ignore 
