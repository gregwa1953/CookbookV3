...
#    Mar 03, 2020 05:52:07 AM CST  platform: Linux
...
class formConfig:
    def __init__(self, top=None):
        ...
        font17 = "-family {Ubuntu} -size 10 -weight bold"
        font18 = "-family {Ubuntu} -size 10 -weight bold"
        ...
        self.TNotebook1.place(x=5, y=5, height=485, width=745)
        ...
        self.Label1.place(x=20, y=100,  height=19, width=186)
        ...
        self.Message1.configure(font=font17)
        ...
        self.Entry1.configure(textvariable=formConfig_support.defImagePath)
        ...
        self.chkAllRecs = tk.Checkbutton(self.TNotebook1_t1)
        self.chkAllRecs.place(x=245, y=139, height=21, width=63)
        self.chkAllRecs.configure(anchor='w')
        self.chkAllRecs.configure(justify='left')
        self.chkAllRecs.configure(variable=formConfig_support.chkShowAllRecs)

        self.Label2 = tk.Label(self.TNotebook1_t1)
        self.Label2.place(x=20, y=140,  height=19, width=216)
        self.Label2.configure(anchor='e')
        self.Label2.configure(font=font18)
        self.Label2.configure(text='''Show all records by default:''')

        self.TCombobox1 = ttk.Combobox(self.TNotebook1_t2)
        self.TCombobox1.place(x=250, y=50, height=19, width=177)
        self.TCombobox1.configure(textvariable=formConfig_support.combobox)
        self.TCombobox1.configure(takefocus="")

        self.Label3 = tk.Label(self.TNotebook1_t2)
        self.Label3.place(x=20, y=50,  height=19, width=206)
        self.Label3.configure(anchor='e')
        self.Label3.configure(font=font18)
        self.Label3.configure(text='''Default Theme:''')
        ...
        self.btnExit.place(x=714, y=3,  height=35, width=35)
