...
#    Mar 05, 2020 03:50:15 PM CST  platform: Linux
...
import cbv3MainLT_support

def vp_start_gui():
    '''Starting point when module is the main routine.'''
    global val, w, root
    root = tk.Tk()
    cbv3MainLT_support.set_Tk_var()
    top = formCookbookMain (root)
    cbv3MainLT_support.init(root, top)
    root.mainloop()
...
def create_formCookbookMain(rt, *args, **kwargs):
    ...
    cbv3MainLT_support.init(w, top, *args, **kwargs)
    return (w, top)
...
class formCookbookMain:
    def __init__(self, top=None):
        ...
        self.frameToolbar.place(relx=0.0, rely=0.0, relheight=0.058
                , relwidth=0.997)
        ...
        self.btnExit.place(relx=0.956, rely=0.109, height=35, width=38)
        self.btnExit.configure(activebackground="#f9f9f9")
        self.btnExit.configure(command=cbv3MainLT_support.on_btnExit)
        ...
        self.btnAdd.place(relx=0.095, rely=0.109, height=35, width=38)
        self.btnAdd.configure(activebackground="#f9f9f9")
        self.btnAdd.configure(command=cbv3MainLT_support.on_btnAdd)
        ...
        self.btnDelete.place(relx=0.134, rely=0.109, height=35, width=38)
        self.btnDelete.configure(activebackground="#f9f9f9")
        self.btnDelete.configure(command=cbv3MainLT_support.on_btnDelete)
        ...
        self.btnEdit.place(relx=0.19, rely=0.109, height=35, width=38)
        self.btnEdit.configure(activebackground="#f9f9f9")
        self.btnEdit.configure(command=cbv3MainLT_support.on_btnEdit)
        ...
        self.btnScrape.place(relx=0.398, rely=0.109, height=35, width=38)
        self.btnScrape.configure(activebackground="#f9f9f9")
        self.btnScrape.configure(command=cbv3MainLT_support.on_btnScrape)
        ...
        self.btnPrint.place(relx=0.498, rely=0.109, height=35, width=38)
        self.btnPrint.configure(activebackground="#f9f9f9")
        self.btnPrint.configure(command=cbv3MainLT_support.on_btnPrint)
        ...
        self.btnUtils.place(relx=0.605, rely=0.109, height=35, width=38)
        self.btnUtils.configure(activebackground="#f9f9f9")
        self.btnUtils.configure(command=cbv3MainLT_support.on_btnUtils)
        ...
        self.btnConfig.place(relx=0.697, rely=0.109, height=35, width=38)
        self.btnConfig.configure(activebackground="#f9f9f9")
        self.btnConfig.configure(command=cbv3MainLT_support.on_btnConfig)
        ...
        self.frameStatus.place(relx=0.001, rely=0.939, relheight=0.058
                , relwidth=0.997)
        ...
        self.lblTimeDisplay.place(relx=0.924, rely=0.217, height=26, width=86)
        self.lblTimeDisplay.configure(activebackground="#f9f9f9")
        self.lblTimeDisplay.configure(text='''Label''')
        self.lblTimeDisplay.configure(textvariable=cbv3MainLT_support.TimeDisp)

        self.frameNavigate = tk.Frame(top)
        self.frameNavigate.place(relx=0.0, rely=0.056, relheight=0.882
                , relwidth=0.276)
        ...
        self.Frame2.place(relx=0.0, rely=0.719, relheight=0.281, relwidth=0.989)
        self.Frame2.configure(relief='ridge')
        self.Frame2.configure(borderwidth="2")
        self.Frame2.configure(relief="ridge")

        self.Label1 = tk.Label(self.Frame2)
        self.Label1.place(relx=0.058, rely=0.101, height=19, width=81)
        ...
        self.rbIngredients.configure(variable=cbv3MainLT_support.selectedButton)

        self.Checkbutton1 = tk.Checkbutton(self.Frame2)
        self.Checkbutton1.place(relx=0.634, rely=0.202, relheight=0.096
                , relwidth=0.326)
        self.Checkbutton1.configure(activebackground="#f9f9f9")
        self.Checkbutton1.configure(anchor='w')
        self.Checkbutton1.configure(command=cbv3MainLT_support.on_chkClick)
        self.Checkbutton1.configure(justify='left')
        self.Checkbutton1.configure(state='disabled')
        self.Checkbutton1.configure(text='''Show All''')
        self.Checkbutton1.configure(variable=cbv3MainLT_support.che46)
        tooltip_font = "-family {DejaVu Sans} -size 9"
        ToolTip(self.Checkbutton1, tooltip_font, '''Show Deleted Records as well''', delay=0.5)

        self.Entry1 = tk.Entry(self.Frame2)
        self.Entry1.place(relx=0.115, rely=0.758,height=29, relwidth=0.686)
        self.Entry1.configure(background="white")
        self.Entry1.configure(font="-family {DejaVu Sans Mono} -size 9")
        self.Entry1.configure(selectbackground="#c4c4c4")
        self.Entry1.configure(state='disabled')
        self.Entry1.configure(textvariable=cbv3MainLT_support.EntryText)
        self.Entry1.bind('<KeyRelease>',lambda e:cbv3MainLT_support.on_Entry_Return(e))

        self.Frame3 = tk.Frame(self.frameNavigate)
        self.Frame3.place(relx=0.0, rely=0.0, relheight=0.716, relwidth=0.989)
        ...
        self.Scrolledtreeview1.place(relx=0.0, rely=0.0, relheight=0.996
                , relwidth=0.994)
        ...
        self.Frame1.place(relx=0.276, rely=0.059, relheight=0.87, relwidth=0.722)
        ...
        self.Scrolledtext1.place(relx=0.441, rely=0.542, relheight=0.456
                , relwidth=0.558)
        ...
        self.Scrolledlistbox1.place(relx=0.011, rely=0.542, relheight=0.456
                , relwidth=0.42)
        ...
        self.lblTitle.place(relx=0.022, rely=0.012, height=36, width=568)
        ...
        self.lblTitle.configure(textvariable=cbv3MainLT_support.RecipeTitle)

        self.lblImage = tk.Label(self.Frame1)
        self.lblImage.place(relx=0.656, rely=0.026, height=275, width=302)
        ...
        self.msgCategories.place(relx=0.098, rely=0.462, relheight=0.058
                , relwidth=0.88)
        self.msgCategories.configure(relief="ridge")
        self.msgCategories.configure(text='''Message''')
        self.msgCategories.configure(textvariable=cbv3MainLT_support.RecipeCategories)
        self.msgCategories.configure(width=805)

        self.lblID = tk.Label(self.Frame1)
        self.lblID.place(relx=0.022, rely=0.476, height=17, width=46)
        self.lblID.configure(activebackground="#f9f9f9")
        self.lblID.configure(text='''Label''')
        self.lblID.configure(textvariable=cbv3MainLT_support.IdLableShow)

        self.Label2 = tk.Label(self.Frame1)
        self.Label2.place(relx=0.025, rely=0.094, height=17, width=86)
        ...
        self.Label3.place(relx=0.036, rely=0.147, height=17, width=76)
        ...
        self.Label4.place(relx=0.033, rely=0.278, height=18, width=83)
        ...
        self.lblTotalTime.place(relx=0.13, rely=0.184, height=28, width=468)
        ...
        self.lblTotalTime.configure(textvariable=cbv3MainLT_support.RecipeTotalTime)

        self.Label5 = tk.Label(self.Frame1)
        self.Label5.place(relx=0.022, rely=0.191, height=18, width=89)
        ...
        self.Label6.place(relx=0.131, rely=0.227, height=28, width=468)
        ...
        self.Label6.configure(textvariable=cbv3MainLT_support.RecipeRating)

        self.Label7 = tk.Label(self.Frame1)
        self.Label7.place(relx=0.033, rely=0.235, height=18, width=79)
        ...
        self.stNotes.place(relx=0.131, rely=0.271, relheight=0.186
                , relwidth=0.513)
        ...
        self.lblServings = tk.Message(self.Frame1)
        self.lblServings.place(relx=0.131, rely=0.14, relheight=0.04
                , relwidth=0.509)
        self.lblServings.configure(font="-family {DejaVu Sans} -size 10 -weight bold -slant italic")
        self.lblServings.configure(relief="sunken")
        self.lblServings.configure(text='''Label''')
        self.lblServings.configure(textvariable=cbv3MainLT_support.RecipeServings)
        self.lblServings.configure(width=465)

        self.lblSource = tk.Message(self.Frame1)
        self.lblSource.place(relx=0.131, rely=0.071, relheight=0.066
                , relwidth=0.509)
        self.lblSource.configure(font="-family {DejaVu Sans} -size 10 -weight bold -slant italic")
        self.lblSource.configure(relief="sunken")
        self.lblSource.configure(text='''Label''')
        self.lblSource.configure(textvariable=cbv3MainLT_support.RecipeSource)
        self.lblSource.configure(width=465)
