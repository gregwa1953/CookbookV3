...
#    Jan 31, 2020 04:28:04 PM CST  platform: Linux
...
def create_Scraper(rt, *args, **kwargs):
    '''Starting point when module is imported by another module.
       Correct form of call: 'create_Scraper(root, *args, **kwargs)' .'''
    global w, w_win, root
    #rt = root
    root = rt
    w = tk.Toplevel (root)
...
class Scraper:
    def __init__(self, top=None):
        ...
        self.lblTitle.place(relx=0.154, rely=0.139, height=31, width=652)
        ...
        self.Scrolledlistbox1.place(relx=0.273, rely=0.613, relheight=0.371
                , relwidth=0.277)
        ...
        self.Scrolledtext1.place(relx=0.562, rely=0.613, relheight=0.371
                , relwidth=0.41)
        ...
        self.lblImageURL.place(relx=0.154, rely=0.29, height=74, width=658)
        ...
        self.lblImage.place(relx=0.71, rely=0.146, height=300, width=301)
        ...
        self.Label7.place(relx=0.281, rely=0.58, height=19, width=125)
        ...
        self.Label8.place(relx=0.57, rely=0.58, height=23, width=149)
        ...
        self.btnSaveToDB.place(relx=0.545, rely=0.219, height=29, width=159)
        ...
        self.Label8_1.place(relx=0.025, rely=0.58, height=23, width=149)
        ...
        self.frameCustomWidget.place(relx=0.017, rely=0.613, relheight=0.371
                , relwidth=0.244)
        ...
        self.Message1.place(relx=0.017, rely=0.426, relheight=0.125
                , relwidth=0.244)
        ...
        self.stDescription = ScrolledText(top)
        self.stDescription.place(relx=0.273, rely=0.426, relheight=0.129
                , relwidth=0.423)
        self.stDescription.configure(background="white")
        self.stDescription.configure(font=font12)
        self.stDescription.configure(insertborderwidth="3")
        self.stDescription.configure(selectbackground="#c4c4c4")
        self.stDescription.configure(wrap="word")

        self.Label6 = tk.Label(top)
        self.Label6.place(relx=0.277, rely=0.394, height=19, width=112)
        self.Label6.configure(activebackground="#f9f9f9")
        self.Label6.configure(anchor='w')
        self.Label6.configure(font="-family {Ubuntu} -size 11 -weight bold")
        self.Label6.configure(text='''Description:''')
    ...
    def popup1(event, *args, **kwargs):
        ...
        Popupmenu1.add_command(
                ...
                background="#d9d9d9",
                command=lambda:ScraperGUI1_support.on_popPaste(args[0]),
        ...
        Popupmenu1.add_command(
                ...
                activeforeground="#000000",
                background="#d9d9d9",
                command=lambda:ScraperGUI1_support.on_popCopy(args[0]),
                font=('-family {DejaVu Sans} -size 9'),
                foreground="#000000",
                label="Copy")
        Popupmenu1.add_separator(
        ...
        Popupmenu1.add_command(
                ...
                activeforeground="#000000",
                background="#d9d9d9",
                command=lambda:ScraperGUI1_support.on_popClear(args[0]),
                font=('-family {DejaVu Sans} -size 9'),
                foreground="#000000",
                label="Clear")
