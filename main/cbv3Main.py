...
#    Dec 23, 2020 03:55:29 AM CST  platform: Linux
...
class formCookbookMain:
    def __init__(self, top=None):
        ...
        font13 = "-family {Liberation Sans} -size 9 -weight bold"
        ...
        self.frameToolbar.place(x=0, y=0, height=50, width=1266)
        ...
        self.btnExit.place(x=1210, y=3, height=38, width=38)
        ...
        self.tooltip_font = "-family {DejaVu Sans} -size 9"
        self.btnExit_tooltip = \
        ToolTip(self.btnExit, self.tooltip_font, '''Exit the program''')

        self.btnAdd = tk.Button(self.frameToolbar)
        self.btnAdd.place(x=120, y=3, height=38, width=38)
        ...
        self.tooltip_font = "-family {DejaVu Sans} -size 9"
        self.btnAdd_tooltip = \
        ToolTip(self.btnAdd, self.tooltip_font, '''Add a new recipe''')

        self.btnDelete = tk.Button(self.frameToolbar)
        self.btnDelete.place(x=170, y=3, height=38, width=38)
        ...
        ToolTip(self.btnDelete, self.tooltip_font, '''Delete the current recipe''')

        self.btnEdit = tk.Button(self.frameToolbar)
        self.btnEdit.place(x=241, y=3, height=38, width=38)
        ...
        ToolTip(self.btnEdit, self.tooltip_font, '''Edit the current recipe''')

        self.btnScrape = tk.Button(self.frameToolbar)
        self.btnScrape.place(x=504, y=3, height=38, width=38)
        ...
        self.tooltip_font = "-family {DejaVu Sans} -size 9"
        self.btnScrape_tooltip = \
        ToolTip(self.btnScrape, self.tooltip_font, '''Scrape a web page''')

        self.btnPrint = tk.Button(self.frameToolbar)
        self.btnPrint.place(x=700, y=3, height=38, width=38)
        ...
        self.tooltip_font = "-family {DejaVu Sans} -size 9"
        self.btnPrint_tooltip = \
        ToolTip(self.btnPrint, self.tooltip_font, '''Print the current recipe''')

        self.btnUtils = tk.Button(self.frameToolbar)
        self.btnUtils.place(x=811, y=3, height=38, width=38)
        ...
        self.tooltip_font = "-family {DejaVu Sans} -size 9"
        self.btnUtils_tooltip = \
        ToolTip(self.btnUtils, self.tooltip_font, '''Database Utilities''')

        self.btnConfig = tk.Button(self.frameToolbar)
        self.btnConfig.place(x=924, y=3, height=38, width=38)
        ...
        ToolTip(self.btnConfig, self.tooltip_font, '''Program Configuration''')

        self.btnTips = tk.Button(self.frameToolbar)
        self.btnTips.place(x=593, y=3, height=38, width=38)
        self.btnTips.configure(activebackground="#f9f9f9")
        self.btnTips.configure(command=cbv3Main_support.on_btnTips)
        self.btnTips.configure(text='''Button''')
        self.tooltip_font = "-family {DejaVu Sans} -size 9"
        self.btnTips_tooltip = \
        ToolTip(self.btnTips, self.tooltip_font, '''Show Tips and Tricks''')

        self.frameStatus = tk.Frame(top)
        self.frameStatus.place(x=0, y=811, height=50, width=1266)
        ...
        self.lblTimeDisplay.place(x=1170, y=10, height=29, width=86)
        ...
        self.frameNavigate.place(x=0, y=53, height=758, width=351)
        ...
        self.Frame2.place(x=0, y=558, height=195, width=347)
        self.Frame2.configure(relief='ridge')
        self.Frame2.configure(borderwidth="2")
        self.Frame2.configure(relief="ridge")

        self.Label1 = tk.Label(self.Frame2)
        self.Label1.place(x=20, y=10, height=21, width=81)
        ...
        self.rbTitle.place(x=40, y=36, height=21, width=92)
        ...
        self.rbCategories.place(x=40, y=60, height=21, width=112)
        ...
        self.rbIngredients.place(x=40, y=84, height=21, width=138)
        ...
        self.Checkbutton1.place(x=210, y=20, height=21, width=113)
        ...
        ToolTip(self.Checkbutton1, self.tooltip_font, '''Show Deleted Records as well''')

        self.Entry1 = tk.Entry(self.Frame2)
        self.Entry1.place(x=20, y=161, height=21, width=310)
        ...
        self.rbFavorites = tk.Radiobutton(self.Frame2)
        self.rbFavorites.place(x=40, y=110, height=23, width=92)
        self.rbFavorites.configure(activebackground="#f9f9f9")
        self.rbFavorites.configure(command=cbv3Main_support.on_rbClick)
        self.rbFavorites.configure(justify='left')
        self.rbFavorites.configure(text='''Favorites''')
        self.rbFavorites.configure(value="3")
        self.rbFavorites.configure(variable=cbv3Main_support.selectedButton)

        self.Frame3 = tk.Frame(self.frameNavigate)
        self.Frame3.place(x=0, y=2, height=550, width=347)
        self.Frame3.configure(relief='ridge')
        self.Frame3.configure(borderwidth="2")
        self.Frame3.configure(relief="ridge")

        self.style.configure('Treeview',  font=font13)
        self.Scrolledtreeview1 = ScrolledTreeView(self.Frame3)
        self.Scrolledtreeview1.place(x=3, y=0, height=548, width=345)
        ...
        self.Frame1.place(x=351, y=52, height=758, width=917)
        self.Frame1.configure(relief='ridge')
        self.Frame1.configure(borderwidth="3")
        self.Frame1.configure(relief="ridge")

        self.Scrolledtext1 = ScrolledText(self.Frame1)
        self.Scrolledtext1.place(x=404, y=411, height=346, width=511)
        self.Scrolledtext1.configure(background="white")
        self.Scrolledtext1.configure(font="-family {DejaVu Sans} -size 9")
        self.Scrolledtext1.configure(insertborderwidth="3")
        self.Scrolledtext1.configure(selectbackground="#c4c4c4")
        self.Scrolledtext1.configure(wrap="word")

        self.Scrolledlistbox1 = ScrolledListBox(self.Frame1)
        self.Scrolledlistbox1.place(x=10, y=411, height=346, width=385)
        self.Scrolledlistbox1.configure(background="white")
        self.Scrolledlistbox1.configure(cursor="xterm")
        self.Scrolledlistbox1.configure(font="-family {DejaVu Sans Mono} -size 9")
        self.Scrolledlistbox1.configure(highlightcolor="#d9d9d9")
        self.Scrolledlistbox1.configure(selectbackground="#c4c4c4")

        self.lblTitle = tk.Label(self.Frame1)
        self.lblTitle.place(x=60, y=9, height=39, width=527)
        ...
        self.lblImage.place(x=601, y=20, height=300, width=301)
        ...
        self.msgCategories.place(x=90, y=350, height=43, width=806)
        ...
        self.lblID.place(x=20, y=361, height=19, width=46)
        ...
        self.Label2.place(x=23, y=71, height=19, width=86)
        ...
        self.Label3.place(x=33, y=111, height=19, width=76)
        ...
        self.Label4.place(x=30, y=210, height=20, width=83)
        ...
        self.lblTotalTime.place(x=119, y=139, height=30, width=467)
        ...
        self.Label5.place(x=20, y=146, height=20, width=89)
        ...
        self.Label6.place(x=120, y=172, height=30, width=467)
        ...
        self.Label7.place(x=30, y=178, height=20, width=79)
        ...
        self.stNotes.place(x=120, y=205, height=140, width=469)
        self.stNotes.configure(background="white")
        self.stNotes.configure(font="-family {DejaVu Sans} -size 9")
        ...
        self.lblServings.place(x=120, y=106, height=30, width=466)
        ...
        self.lblSource.place(x=120, y=53, height=50, width=466)
        self.lblSource.configure(cursor="crosshair")
        self.lblSource.configure(font="-family {DejaVu Sans} -size 10 -weight bold -slant italic")
        self.lblSource.configure(foreground="blue2")
        ...
        self.lblFave = tk.Label(self.Frame1)
        self.lblFave.place(x=7, y=3, height=50, width=50)
        self.lblFave.configure(activebackground="#f9f9f9")
        self.lblFave.configure(borderwidth="2")
        self.lblFave.configure(relief="ridge")
        self.lblFave.configure(text='''Label''')
        self.lblFave.configure(textvariable=cbv3Main_support.LableFavorite)
        self.lblFave.bind('<Button-1>',lambda e:cbv3Main_support.on_lblFaveClick(e))
