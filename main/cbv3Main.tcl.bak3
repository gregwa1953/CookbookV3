...
#  Jan 19, 2020 07:59:57 PM CST  platform: Linux
set vTcl(timestamp) ""
...
proc vTclWindow.top43 {base} {
    ...
    wm geometry $top 1270x861+248+56
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    place $site_3_0.but48 \
        -in $site_3_0 -x 1210 -y 6 -width 32 -relwidth 0 -height 32 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.but43 \
        -in $site_3_0 -x 279 -y 3 -width 38 -relwidth 0 -height 38 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.but44 \
        -in $site_3_0 -x 334 -y 4 -width 38 -relwidth 0 -height 38 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.but45 \
        -in $site_3_0 -x 413 -y 3 -width 38 -relwidth 0 -height 38 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.but46 \
        -in $site_3_0 -x 190 -y 5 -width 38 -relwidth 0 -height 38 \
        -relheight 0 -anchor nw -bordermode ignore 
    ...
    checkbutton $site_4_0.che46 \
        ...
        -font TkDefaultFont -foreground $vTcl(actual_gui_fg) \
        -highlightcolor black -justify left -text {Show All} -variable che46 
    ...
    message $site_3_0.mes47 \
        -background $vTcl(actual_gui_bg) -font TkDefaultFont \
        -foreground $vTcl(actual_gui_fg) -highlightcolor black -relief ridge \
        -text Message -textvariable RecipeNotes -width 455 
    vTcl:DefineAlias "$site_3_0.mes47" "msgNotes" vTcl:WidgetProc "formCookbookMain" 1
    ...
    place $site_3_0.scr53 \
        -in $site_3_0 -x 4 -y 409 -width 396 -relwidth 0 -height 342 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.lab43 \
        -in $site_3_0 -x 20 -y 30 -width 556 -relwidth 0 -height 39 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.lab44 \
        -in $site_3_0 -x 600 -y 20 -width 300 -relwidth 0 -height 300 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.lab45 \
        -in $site_3_0 -x 120 -y 80 -width 456 -relwidth 0 -height 29 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.lab46 \
        -in $site_3_0 -x 120 -y 120 -width 456 -relwidth 0 -height 29 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.mes47 \
        -in $site_3_0 -x 120 -y 170 -width 455 -relwidth 0 -height 153 \
        -relheight 0 -anchor nw -bordermode ignore 
