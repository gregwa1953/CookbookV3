#############################################################################
# Generated by PAGE version 5.1.1c
#  in conjunction with Tcl version 8.6
#  Apr 23, 2020 08:00:58 AM CDT  platform: Linux
set vTcl(timestamp) ""
...
proc vTclWindow.top43 {base} {
    ...
    place $site_3_0.but45 \
        -in $site_3_0 -x 40 -y 7 -width 40 -relwidth 0 -height 40 \
    ...
    label $site_3_0.lab48 \
        ...
        -text Label -textvariable lblTime 
    ...
    frame $top.fra49 \
        -borderwidth 2 -relief groove -background $vTcl(actual_gui_bg) \
        -height 605 -highlightcolor black -width 665 
    ...
    $site_3_0.scr50.01 configure -background white \
        -font "-family {Liberation Sans} -size 11 -weight bold" \
        -foreground black \
        -height 3 \
    ...
    place $site_3_0.scr50 \
        -in $site_3_0 -x 0 -y 0 -width 658 -relwidth 0 -height 595 \
        -relheight 0 -anchor nw -bordermode ignore 
    frame $top.fra51 \
        -borderwidth 2 -relief groove -background $vTcl(actual_gui_bg) \
        -height 625 -highlightcolor black -width 385 
    vTcl:DefineAlias "$top.fra51" "Frame2" vTcl:WidgetProc "Toplevel1" 1
    set site_3_0 $top.fra51
    frame $site_3_0.fra52 \
        -borderwidth 2 -relief groove -background $vTcl(actual_gui_bg) \
        -height 505 -highlightcolor black -width 375 
    ...
    frame $site_3_0.fra53 \
        -borderwidth 2 -relief groove -background $vTcl(actual_gui_bg) \
        -height 105 -highlightcolor black -width 385 
